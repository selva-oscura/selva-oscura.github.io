...
const ProjectModal = props => {
  ...
  if (
    props.selectedProject === props.project.target &&
    props.deselectedProject
  ) {
    ...
    >
      <div className={modalContent}>
        <div className="modal-header">
          <span className="modal-close" onClick={props.unselectProject}>
            x
          </span>
          <h2>
            {props.project.name}
