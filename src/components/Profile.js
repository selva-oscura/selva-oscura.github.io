				...
				<div className="container">
					<header>
						...
						<div id="summary">
							...
							<p>For two recent client projects, I used Meteor's reactive programming framework to develop fast, secure websites, backed by MongoDB's databases, and utilized Node.js server-side cron jobs to automate notifications &nbsp; reports and to clear holds for uncompleted transactions (see Door-to-Door Shines
									<LinkToProject
										text="description"
										target="shines"
										selectProject={props.selectProject}
									/>
									&nbsp;or <a href="https://www.doortodoorshines.com" target="shines">live</a>), and to update data that clients are monitoring (see
									<LinkToProject
										text="Zyrl"
										target="zyrl"
										selectProject={props.selectProject}
							...
							<p>In my personal projects and at hackathons, I've enjoyed exploring HTML5's new APIs, the myriad JS libraries & frameworks, and the ever greater browser capabilities:</p>
									<ul>
										<li>to use React, web workers, and local storage on the client to make <a href="https://developers.google.com/web/progressive-web-apps/" target="pwa">Progressive Web App</a> games (see
											<LinkToProject
												text="Sudoku"
												target="sudoku"
												selectProject={props.selectProject}
										...
										<li>to use Meteor.js, MongoDB, <a href="http://materializecss.com/" target="materialize">Materialize.css</a> (an adaptation of Google's Material Design), and <a href="http://peerjs.com/" target="peerjs">PeerJS</a> to implement a Portal-themed <a href="https://webrtc.org/" target="webrtc">WebRTC</a> live video chat site (see
												<LinkToProject
													text="PoRTCal"
													target="portcal"
													selectProject={props.selectProject}
										...
										<li>to use Meteor.js, <a href="https://v4-alpha.getbootstrap.com/" target="bootstrap">TwitterBootstrap</a>, MongoDB, and geolocation & search criteria to match would-be pet owners with adoptable animals (see
												<LinkToProject
													text="Animal Rescue"
