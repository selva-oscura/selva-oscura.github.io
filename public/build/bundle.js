...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProjectFilters = function ProjectFilters(props) {
	  var filters = [{ all: 'All' }, { node: 'Node.js' }, { mongo: 'MongoDB' }, { meteor: 'Meteor' }, { react: 'React' }, { angular: 'Angular' }, { pwa: 'Progressive Web App (PWA)' }, { webrtc: 'WebRTC' }, { d3: 'D3' }, { svg: 'svg' }, { php: 'PHP' }, { lamp: 'PHP / MySQL' }];
	  return _react2.default.createElement(
	    'div',
