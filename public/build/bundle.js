...
/***/ (function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(169);
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "a",
	            { href: "#profile", className: "button big scrolly home" },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Profile = function Profile(props) {
	  var skillAreas = [{
	    icon: 'fa-user-circle',
	    skillArea: 'Front End',
	    skills: ['HTML5', 'CSS3', 'JavaScript / ES6', 'React', 'Redux', 'jQuery', 'Angular', 'Progressive Web Apps (PWAs)', 'CSS Libraries: Bootstrap, Material Design, Material-UI, HTML5UP']
	  }, {
	    icon: 'fa-server',
	    skillArea: 'Back End',
	    ...
	    icon: 'fa-cogs',
	    skillArea: 'Sundry',
	    skills: ['Interfaces: GraphQL', 'Package Management: npm, yarn', 'Linting: eslint, jshint, prettier', 'Version Control: git', 'PaaS: Galaxy, Heroku', 'DBaaS: mLab', 'APIs: Facebook, Instagram, OpenWeather, Stripe, & many more', 'Wireframe: Balsamiq']
	  }];
	  return _react2.default.createElement(
	    'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              null,
	              'Currently I am using React and GraphQL, connecting to a PostgreSQL database, to develop a public-facing website for Local Majority, a grassroots organization seeking to mobilize voters. While the project is very much still in development, screenshots \u2014 admittedly with some lorem ipsum text and placekitten images \u2014 are available (see',
	            ...
	            _react2.default.createElement(
	              'p',
	              null,
	              'For two other recent client projects, I used Meteor\'s reactive programming framework to develop fast, secure websites, backed by MongoDB\'s databases, and utilized Node.js server-side cron jobs to automate notifications & reports and to clear holds for uncompleted transactions (see',
	              _react2.default.createElement(_LinkToProject2.default, {
	            ...
	            _react2.default.createElement(
	              'p',
	              null,
	              'In my personal projects and at hackathons, I\'ve enjoyed exploring HTML5\'s new APIs, the myriad JS libraries & frameworks, and browsers\' ever greater capabilities:'
	            ),
	            _react2.default.createElement(
	              'ul',
	              null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProjectFilters = function ProjectFilters(props) {
	  var filters = [{ all: 'All' }, { node: 'Node.js' }, { mongo: 'MongoDB' }, { meteor: 'Meteor' }, { react: 'React' }, { redux: 'Redux' }, { graphQL: 'GraphQL' }, { angular: 'Angular' }, { pwa: 'Progressive Web App (PWA)' }, { webrtc: 'WebRTC' }, { d3: 'D3' }, { svg: 'svg' }, { php: 'PHP' }, { lamp: 'PHP / MySQL' }];
	  return _react2.default.createElement(
	    'div',
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { className: 'main', style: screenshot }),
	        _react2.default.createElement(
	          'div',
	          { className: 'screenshot-nav next', onClick: handleNextClick },
...
/***/ (function(module, exports) {
	...
	module.exports = {"projects":[{"src":"public/img/localmajority.png","name":"Local Majority","web":"","git":"https://github.com/selva-oscura/localmajority","internalProject":false,"node":true,"meteor":true,"react":false,"redux":false,"angular":false,"mongo":true,"graphQL":true,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"client","target":"localmajority","screenshots":["localmajority_index.png","localmajority_candidates.png","localmajority_candidate.png","localmajority_states.png","localmajority_reports.png","localmajority_about_us.png"],"screenshotCaptions":["Local Majority | Home Page","Local Majority | Candidates","Local Majority | Candidate","Local Majority | States","Local Majority | Reports","Local Majority | About Us"],"text":["Local Majority (in development) will a app for providing state-level election, voting, and issues information to progressive voters. The project includes a public-facing website for providing voters with information, an internal website for updating the database, and a shared database.","My work on the project was focused on designing and developing the public-facing website, using React and GraphQL, to provide profiles on state-level candidates, articles about local and state issues, and information regarding voting registration, deadlines, and calls to action to be involved in mobilizing other voters."],"technologies":"React, Node.js, JavaScript/ES6, GraphQL, HTML5, CSS3, Bootstrap, Material-UI"},{"src":"public/img/shines.png","name":"Door-to-Door Shines","web":"","git":"","internalProject":false,"node":true,"meteor":true,"react":false,"redux":false,"angular":false,"mongo":true,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"client","target":"shines","screenshots":["shines_home.png","shines_order.png"],"screenshotCaptions":["Door-to-Door Shines | Home Page","Door-to-Door Shines | Order Page"],"text":["Door-to-Door Shines is an app to help busy people in the San Francisco Area with on-demand shoe shine and repair services.  Select the services you want, schedule pick-up and return times that are convenient for you, pay, and cross one more errand off your list!","As sole developer for Door-to-Door Shines, I built (1) the interfaces the user sees as s/he orders shine & repair services, schedules pick-up & delivery times, pays, leaves comments or asks questions; (2) the admin dashboard, displaying pending & completed orders, user feedback, & customer information, scheduling of delivery times, analytics on orders and revenue; and (3) the internals, including database and cron jobs."],"technologies":"Meteor.js, MongoDB, Node.js, JavaScript/ES6, jQuery, HTML5, CSS3, Materialize.css, moment.js, meteor-synced-cron, Stripe API"},{"src":"public/img/zyrl.png","name":"Zyrl","web":"","git":"","internalProject":true,"node":true,"meteor":true,"react":false,"redux":false,"angular":false,"mongo":true,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"client","target":"zyrl","screenshots":["zyrl_index.png","zyrl_influencers.png","zyrl_brand.png","zyrl_about_us.png"],"screenshotCaptions":["Zyrl | Home Page","Zyrl | Influencers","Zyrl | Brands","Zyl | About Us"],"text":["Zyrl is an app for connecting social media influencers and the merchants whose products and services they love.","As a freelancer for Zyrl, I converted the site from WordPress to Meteor, rebuilt the app's front-end and back-end (sign-up and communications for influencers, merchants, and potential employees) and arranged site and database hosting. I then the Facebook and Instagram permissions process, designed and developed the internal APIs & the management of data from Facebook and Instagram's APIs, and designed the admin dashboard for managing influencers/merchants, admin permissions, and display of analytics of  influencers' Facebook and Instagram profiles and posts data."],"technologies":"Meteor.js, MongoDB, Node.js, JavaScript/ES6, jQuery, HTML5, CSS3, Bootstrap, Facebook Graph API, Instagram API"},{"src":"public/img/portfolio.png","name":"Portfolio Page","git":"https://github.com/selva-oscura/selva-oscura.github.io","web":"https://selva-oscura.github.io/","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"portfolio","text":["This is the portfolio page at which you are currently looking. As of 8/25/2017, it remains a work in progress. Starting as a vanilla html site (based on the Free Code Camp portfolio project), the project has undergone repeated iterations: conversion to React, multiple theme changes, addition of animations and new sections....."],"technologies":"React.js, JavaScript/ES6, jQuery, HTML5, CSS3, HTML5Up"},{"src":"public/img/sudoku.png","name":"Sudoku","git":"https://github.com/selva-oscura/react-sudoku","web":"https://selva-oscura.github.io/react-sudoku","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"sudoku","text":["Progressive Web App version of Sudoku.","The game was built as a personal project while learning React, the joy of data structures and algorithms (delving into all of the wonderful logic of how to make a filled-out Sudoku board, scramble the numbers a bit, and remove numbers albeit only to the extent that they can be deduced without need to resort to guessing), Progressive Web Apps, service workers, storage of state and the app shell in the browser, and Lighthouse."],"technologies":"React.js, JavaScript/ES6, Progressive Web App (PWA), Service Workers and local storage"},{"src":"public/img/cryptoglance.png","name":"CryptoGlance","git":"https://github.com/selva-oscura/cryptowatch-2.0","web":"https://selva-oscura.github.io/cryptowatch-2.0","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":true,"svg":true,"lamp":false,"purpose":"personal","target":"cryptoglance","text":["Inspired by the cryptowat.ch website, this hack night project was an excuse to play with React.js, APIs, web sockets, and D3.js. Project members included Carol St. Louis, Neil Ricci, and Swizec Teller.","Using data from CryptoCompare, the app uses axios for API calls to fetch historical data and socket.io-client for web sockets to subscribe to current price quotes.","Graphs of the historical data were implemented with D3.js."],"technologies":"React.js, D3.js, API calls, web sockets, JavaScript/ES6"},{"src":"public/img/gitup.png","name":"GitUp","git":"https://github.com/selva-oscura/react-pwa-git-trending","web":"https://selva-oscura.github.io/react-pwa-git-trending","internalProject":false,"node":true,"meteor":false,"react":true,"redux":true,"angular":false,"mongo":false,"graphQL":false,"pwa":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"gitup","text":["Progressive Web App for checking top and trending repositories on GitHub (with options to search by language and keywords).","Built as a personal project, mostly as an excuse to play with React, Redux, API calls, and progressive Web Apps (PWAs), service workers, storage of state and the app shell in the browser, and Lighthouse."],"technologies":"React.js, Redux, JavaScript/ES6, API call (to GitHub), Progressive Web App (PWA), Service Workers and local storage"},{"src":"public/img/hangman.png","name":"Hangman","git":"https://github.com/selva-oscura/react-hangman","web":"https://selva-oscura.github.io/react-hangman","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"hangman","text":["Progressive Web App version of the familiar word game Hangman, albeit with SAT words.","The game was built as a personal project while learning React, Progressive Web Apps, service workers, storage of state and the app shell in the browser, and Lighthouse."],"technologies":"React.js, JavaScript/ES6, Progressive Web App (PWA), Service Workers and local storage"},{"src":"public/img/weather.png","name":"Weather","git":"https://github.com/selva-oscura/react-weather-spa","web":"https://selva-oscura.github.io/react-weather-spa","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"weather","text":["Progressive Web App Weather App.","Built as a personal project while delving into ES6, learning React and how it handles API calls, Progressive Web Apps, service workers, storage of state and the app shell in the browser, and Lighthouse."],"technologies":"React.js, JavaScript/ES6, Progressive Web App (PWA), Service Workers and local storage, axios, OpenWeather API"},{"src":"public/img/tic-tac-toe.png","name":"Tic-Tac-Toe","git":"https://github.com/selva-oscura/react-tic-tac-toe","web":"https://selva-oscura.github.io/react-tic-tac-toe","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"tic-tac-toe","text":["Progressive Web App version of Tic-Tac-Toe.","The game was built as a personal project while playing with JavaScript logic, delving into ES6, and learning React, Progressive Web Apps, service workers, storage of state and the app shell in the browser, and Lighthouse."],"technologies":"React.js, JavaScript/ES6, Progressive Web App (PWA), Service Workers and local storage"},{"src":"public/img/color-slider.png","name":"Color Slider","git":"https://github.com/selva-oscura/react-color-slider","web":"","codepen":"https://codepen.io/stlouis_c/pen/RKWRYK","internalProject":false,"node":true,"meteor":false,"react":true,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"color-slider","text":["React-based color slider.","Just an excuse to play with React, state, event handlers, code reuse with components, a little dabbling with Facebook's Jest testing framework, HTML5's range input, and the hsla way of depicting colors."],"technologies":"React.js, JavaScript, HTML5"},{"src":"public/img/portcal.jpg","name":"PoRTCal","git":"https://github.com/selva-oscura/poRTCal","web":"","internalProject":false,"node":true,"meteor":true,"react":false,"redux":false,"angular":false,"mongo":true,"graphQL":false,"pwa":false,"webrtc":true,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"portcal","text":["PoRTCal is a WebRTC app inspired by the game Portal. The project was an entry into the October 2015 Meteor hackathon competition. Users could videoconference with each other by logging in to the app."],"technologies":"Meteor.js, MongoDB, Node.js, HTML5, CSS3, Materialize.css, JavaScript/ES6, WebRTC using the PeerJS library"},{"src":"public/img/animal_rescue.png","name":"Animal Rescue","git":"https://github.com/selva-oscura/meteor_animal_rescue","web":"","internalProject":false,"node":true,"meteor":true,"react":false,"redux":false,"angular":false,"mongo":true,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"animal_rescue","text":["Animal Rescue is an app for uploading and finding animals that are available for adoption, make with Meteor, MongoDB, and Bootstrap.","This project was developed and won 2nd place at the Women Who Code Silicon Valley hackathon at Paypal in April 2015."],"technologies":"Meteor.js, MongoDB, Node.js, HTML5, CSS3, Bootstrap, MapQuest Geolocation API"},{"src":"public/img/booksmart.png","name":"Booksmart","git":"","web":"http://booksmartapp.com","internalProject":false,"node":false,"meteor":false,"react":false,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":true,"php":true,"purpose":"client","target":"booksmart","text":["Sole developer and lead maintainer of the web platform for a web, iOS, and Android project, created in collaboration with a team of mobile app developers to help students (1) contact other students at their university to buy or sell textbooks with one another and (2) buy from or sell to online vendors for students at universities where the app is not yet broadly adopted."],"technologies":"HTM5, CSS3, Bootstrap, PHP, MySQL, JavaScript, AJAX, jQuery, Campusbooks API"},{"src":"public/img/elementaryBuddies.png","name":"Elementary Buddies","git":"https://github.com/selva-oscura/elementaryBuddies","web":"","internalProject":false,"node":true,"meteor":false,"react":false,"redux":false,"angular":true,"mongo":true,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"elementaryBuddies","text":["As a group project with Poema Cavalcanti, Jameela Huq, and Parisa Kianmajd for LinkedIn's DevelopHer Hackathon, 14-15 November 2014, my team created an educational app to introduce students to chemistry and the periodic table.","(The project repository can also be found at https://github.com/pkianmajd/chem)"],"technologies":"HTML5, CSS3, MEAN (MongoDB, Express, Angular, Node.js)"},{"src":"public/img/chitter.jpg","name":"Chitter","git":"https://github.com/selva-oscura/chitter","web":"","internalProject":false,"node":true,"meteor":false,"react":false,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"webrtc":false,"d3":false,"svg":false,"lamp":false,"purpose":"personal","target":"chitter","text":["Chitter - a basic chat app -- Really just an opportunity to play with node, express.io, and the joy of sockets!","Developed at Coding Dojo August 2014."],"technologies":"Node.js, express.io, websockets, HTML5, CSS3"},{"src":"public/img/pounce.png","name":"Pounce","git":"https://github.com/selva-oscura/pounce","web":"","internalProject":false,"node":true,"meteor":false,"react":false,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":true,"svg":true,"lamp":false,"purpose":"personal","target":"pounce","text":["Game - click the bouncing targets to destroy them -- Really just playing with JavaScript, jQuery, and D3.js.","Developed at Coding Dojo July 2014."],"technologies":"HTML5, CSS3, D3.js"},{"src":"public/img/raindrops.png","name":"Raindrops","git":"https://github.com/selva-oscura/raindrops","web":"","internalProject":false,"node":true,"meteor":false,"react":false,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":false,"svg":true,"lamp":false,"purpose":"personal","target":"raindrops","text":["Non-interactive graphics - circles appear, spread and fade, and ultimately disappear -- Really just playing with JavaScript, jQuery, and svg.","Developed at Coding Dojo July 2014."],"technologies":"HTML5, CSS3, JavaScript, jQuery"},{"src":"public/img/aloha_fun_zone.png","name":"Aloha Fun Zone","web":"http://alohafunzone.com","git":"","internalProject":false,"node":false,"meteor":false,"react":false,"redux":false,"angular":false,"mongo":false,"graphQL":false,"pwa":false,"d3":false,"svg":false,"lamp":false,"php":true,"purpose":"client","target":"aloha","text":["Sole developer and maintainer of Aloha Fun Zone website, which displays the tours available from the company."],"technologies":"HTM5, CSS3, PHP, JavaScript, AJAX, jQuery"}]}
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "li",
	        null,
	        "\xA9 Carol St. Louis, 2018. All rights reserved."
	      ),
	      _react2.default.createElement(
	        "li",
	        null,
